...
TransactionFlowShell {
    title: "Sending Transaction"; subtitle: "Do not close Holon Wallet"
    ...
    SurfaceCard {
        ...
        Text {
            ...
            text: "Submitting once"; color: Design.text
            font.family: Design.fontFamily; font.pixelSize: 22; font.weight: Font.DemiBold
        }
        Text {
            x: 30; y: 206; width: parent.width - 60; horizontalAlignment: Text.AlignHCenter
            wrapMode: Text.Wrap
            text: "Revalidating public data, signing locally, and making at most one broadcast request."
    ...
    Rectangle {
        ...
        Text {
            ...
            wrapMode: Text.Wrap
            text: "The submission has started and cannot be cancelled. No automatic retry will occur."
